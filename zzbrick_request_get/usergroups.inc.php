...
function mod_mediadblink_get_usergroups($params) {
	if (empty($params)) return mod_mediadblink_get_usergroups_orga();
	if (count($params) !== 1) return false;
	switch ($params[0]) {
		case 'orga': return mod_mediadblink_get_usergroups_orga();
		case 'gremien': return mod_mediadblink_get_usergroups_gremien();
		case 'teilnehmer': return mod_mediadblink_get_usergroups_teilnehmer('teilnehmer');
		case 'referent': return mod_mediadblink_get_usergroups_teilnehmer('referent');
	}
	return false;
}
 ...
 */
function mod_mediadblink_get_usergroups_orga() {
...
function mod_mediadblink_get_usergroups_gremien() {
...
function mod_mediadblink_get_usergroups_teilnehmer($key) {
	$sql = 'SELECT CONCAT(event_id, "-", usergroup_id) AS `objects[foreign_key]`
